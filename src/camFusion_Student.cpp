...
/**
 * Cluster keypoint matches that belong to a given bounding box and remove outliers.
 * @param boundingBox The bounding box to cluster the matches for.
 * @param kptsPrev The keypoints in the previous frame.
...
/**
 * Computes the time-to-collision (TTC) estimate using camera data.
 * @param kptsPrev The keypoints in the previous frame.
 * @param kptsCurr The keypoints in the current frame.
 * @param kptMatches The matches between the keypoints in the previous and current frames.
 * @param frameRate The frame rate of the camera.
 * @param TTC The computed time-to-collision estimate.
...
void computeTTCCamera(std::vector<cv::KeyPoint> &kptsPrev, std::vector<cv::KeyPoint> &kptsCurr,
    ...
    // calculate a TTC estimate based on these 2D camera features
...
/**
 * Computes the time-to-collision (TTC) estimate based on camera features using the constant acceleration model.
 * @param kptsPrev The keypoints in the previous frame.
 * @param kptsCurr The keypoints in the current frame.
 * @param kptMatches The matches between the keypoints in the previous and current frames.
 * @param frameRate The frame rate of the camera.
 * @param TTC The computed time-to-collision estimate.
 * @param TmPrev The previous time-to-collision estimate.
 * @param visImg The optional visualization image.
 */
...
/**
 * Computes the time-to-collision (TTC) using lidar points from the previous and current frames.
 * @param lidarPointsPrev Lidar points from the previous frame.
 * @param lidarPointsCurr Lidar points from the current frame.
 * @param frameRate Frame rate of the camera.
 * @param TTC Time-to-collision value to be computed.
 */
...
/**
 * Matches bounding boxes between two frames based on keypoint correspondences.
 * @param matches Vector of DMatch objects containing keypoint correspondences between two frames.
 * @param bbBestMatches Map of best matched bounding boxes between two frames.
