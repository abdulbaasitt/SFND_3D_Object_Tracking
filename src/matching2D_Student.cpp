...
/**
 * Matches the descriptors of two sets of keypoints using a specified descriptor class, matcher type, and selector type.
 * 
 * @param kPtsSource The keypoints of the source image.
 * @param kPtsRef The keypoints of the reference image.
 * @param descSource The descriptors of the source image.
 * @param descRef The descriptors of the reference image.
 * @param matches The resulting matches between the two sets of keypoints.
 * @param descriptorclass The descriptor class to use for matching.
 * @param matcherType The type of matcher to use for matching.
 * @param selectorType The type of selector to use for matching.
 * 
 * @throws invalid_argument If the specified matcher type or selector type is not supported.
 */
...
/**
 * @brief This function extracts descriptors from keypoints using the specified descriptor type.
 * 
 * @param keypoints The input keypoints.
 * @param img The input image.
 * @param descriptors The output descriptors.
 * @param descriptorType The type of descriptor to use. Valid values are: "BRIEF", "BRISK", "AKAZE", "ORB", "FREAK", and "SIFT".
 * 
 * @throws invalid_argument if an invalid descriptor type is specified.
 */
...
/**
 * Detects keypoints in an image using Shi-Tomasi corner detection algorithm.
 * @param keypoints Vector of keypoints to store the detected keypoints.
 * @param img Input image.
 * @param bVis Flag to enable/disable visualization of the detected keypoints.
 */
 ...
 * 
 * @param keypoints Output vector of keypoints.
 * @param img Input image.
 * @param bVis Flag to enable/disable visualization of results.
 */
...
/**
 * Detects keypoints in an image using a specified detector and performs feature description.
 * @param keypoints Output vector of keypoints.
 * @param img Input image.
 * @param detectorType Type of detector to use. Valid options are "FAST", "BRISK", "ORB", "AKAZE", and "SIFT".
 * @param bVis Flag to enable/disable visualization of keypoints.
 */
